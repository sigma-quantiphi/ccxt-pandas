...
OKX_METHOD_CONFIG: dict[str, MethodConfig] = _build_dual_case_config({
    ...
    "publicGetMarketCandles": MethodConfig(
        data_key="data",
        column_names=("timestamp", "open", "high", "low", "close", "vol", "volCcy", "volCcyQuote", "confirm"),
    ),
    ...
    "publicGetRubikStatContractsLongShortAccountRatio": MethodConfig(
        data_key="data", column_names=("timestamp", "longShortRatio"),
    ),
    ...
    "publicGetRubikStatContractsOpenInterestHistory": MethodConfig(
        data_key="data", column_names=("timestamp", "oi", "oiCcy", "oiUsd"),
    ),
    "publicGetRubikStatContractsOpenInterestVolume": MethodConfig(
        data_key="data", column_names=("timestamp", "oi", "vol"),
    ),
    "publicGetRubikStatMarginLoanRatio": MethodConfig(
        data_key="data", column_names=("timestamp", "ratio"),
    ),
    "publicGetRubikStatTakerVolume": MethodConfig(
        data_key="data", column_names=("timestamp", "sellVol", "buyVol"),
    ),
    "publicGetRubikStatTakerVolumeContract": MethodConfig(
        data_key="data", column_names=("timestamp", "sellVol", "buyVol"),
    ),
    "publicGetRubikStatOptionOpenInterestVolume": MethodConfig(
        data_key="data", column_names=("timestamp", "callOI", "putOI", "callVol", "putVol"),
    ),
    "publicGetRubikStatOptionOpenInterestVolumeRatio": MethodConfig(
        data_key="data", column_names=("timestamp", "oiRatio", "volRatio"),
    ),
    "publicGetRubikStatOptionOpenInterestVolumeExpiry": MethodConfig(
        data_key="data", column_names=("timestamp", "expTime", "callOI", "putOI", "callVol", "putVol"),
    ),
    "publicGetRubikStatOptionOpenInterestVolumeStrike": MethodConfig(
        data_key="data", column_names=("timestamp", "strike", "callOI", "putOI", "callVol", "putVol"),
    ),
    "publicGetRubikStatOptionTakerBlockVolume": MethodConfig(
        data_key="data", column_names=("timestamp", "blockBuyVol", "blockSellVol"),
    ),
    ...
    "privatePostFinanceStakingDefiEthCancelRedeem": MethodConfig(data_key="data", single_dict=True),
    ...
    "privatePostFinanceStakingDefiSolCancelRedeem": MethodConfig(data_key="data", single_dict=True),
    ...
    "privateGetFinanceFlexibleLoanMaxCollateralRedeemAmount": MethodConfig(data_key="data", single_dict=True),
    "privatePostFinanceFlexibleLoanMaxLoan": MethodConfig(data_key="data", single_dict=True),
    "privatePostFinanceFlexibleLoanAdjustCollateral": MethodConfig(data_key="data", single_dict=True),
    # --- Spread trading ---
