...
DEFAULT_NUMERIC_FIELDS: frozenset[str] = (
    CCXT_NUMERIC_FIELDS | BINANCE_NUMERIC_FIELDS | OKX_NUMERIC_FIELDS
)

DEFAULT_BOOL_FIELDS: frozenset[str] = CCXT_BOOL_FIELDS | BINANCE_BOOL_FIELDS | OKX_BOOL_FIELDS

DEFAULT_INT_TO_DATETIME_FIELDS: frozenset[str] = (
    CCXT_INT_TO_DATETIME_FIELDS | BINANCE_INT_TO_DATETIME_FIELDS | OKX_INT_TO_DATETIME_FIELDS
)

DEFAULT_STR_TO_DATETIME_FIELDS: frozenset[str] = (
    CCXT_STR_TO_DATETIME_FIELDS | BINANCE_STR_TO_DATETIME_FIELDS | OKX_STR_TO_DATETIME_FIELDS
)
