...
class AsyncCCXTPandasExchangeTyped(Protocol):
    ...
    def create_order_ws(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Union[NoneType, str, float, int, Decimal] = None, params = {}) -> dict:
    ...
    def fetch_option_chain(self, code: str, params = {}) -> pd.DataFrame:
        """Returns a pd.DataFrame from ccxt.fetch_option_chain"""
        ...

    def watch_ohlcv(self, symbol: str, timeframe: str = '1m', since: int | pd.Timestamp | dict | str | None = None, limit: Int = None, params = {}) -> pd.DataFrame:
    ...
    def fetch_open_interest_history(self, symbol: str, timeframe: str = '1h', since: int | pd.Timestamp | dict | str | None = None, limit: Int = None, params = {}) -> pd.DataFrame:
    ...
    def edit_order_ws(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Union[NoneType, str, float, int, Decimal] = None, price: Union[NoneType, str, float, int, Decimal] = None, params = {}) -> dict:
    ...
    def watch_my_liquidations(self, symbol: str, since: int | pd.Timestamp | dict | str | None = None, limit: Int = None, params = {}) -> pd.DataFrame:
    ...
    def fetch_ohlcv(self, symbol: str, timeframe: str = '1m', since: int | pd.Timestamp | dict | str | None = None, limit: Int = None, params = {}) -> pd.DataFrame:
    ...
    def fetch_orders_ws(self, symbol: Str = None, since: int | pd.Timestamp | dict | str | None = None, limit: Int = None, params = {}) -> pd.DataFrame:
    ...
    def fetch_open_interests(self, symbols: Strings = None, params = {}) -> pd.DataFrame:
    ...
    def cancel_orders_ws(self, ids: List[str], symbol: Str = None, params = {}) -> pd.DataFrame:
    ...
    def fetch_funding_intervals(self, symbols: Strings = None, params = {}) -> pd.DataFrame:
    ...
    def watch_my_liquidations_for_symbols(self, symbols: List[str], since: int | pd.Timestamp | dict | str | None = None, limit: Int = None, params = {}) -> pd.DataFrame:
    ...
    def cancel_all_orders_ws(self, symbol: Str = None, params = {}) -> pd.DataFrame:
