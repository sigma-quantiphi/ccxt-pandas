...
class CCXTPandasExchangeTyped(Protocol):
    ...
    def watchFundingRates(self, symbols: list[str], params = {}) -> DataFrame[FundingRateSchema]:
    ...
    def watch_funding_rates(self, symbols: list[str], params = {}) -> DataFrame[FundingRateSchema]:
